        ...
        {loggedIn&&auth.currentUser&&(
            <>
                <Typography
                    variant="h2" 
                    align="center"
                    sx={{fontSize:"2rem", borderBottom:"1px solid #5d85c9", my:"1rem", pb:".5rem"}}
                ...
                >Your email: {auth.currentUser.email} </Typography>
                ...
                <Typography 
                    ...
                    sx={{fontSize:"1.7rem", fontWeight:100, borderTop:"1px solid #5d85c9", pt:"2rem" }}
                >Liked posts</Typography>
